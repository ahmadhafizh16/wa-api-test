...
<div class="flex-center position-ref full-height">
    <div class="content">
        ...
        <div class="title m-b-md">WhatsApp API Test</div>
        ...
        <?php if(Route::has('public_docs') && Route::has('private_docs')): ?>
            <div class="links">
                <a href="<?php echo e(route('private_docs')); ?>">API Docs</a>
            </div>
        <?php endif; ?>
    </div>
</div>
...
<?php /**PATH /home/ahmad/wa-apiato/app/Containers/AppSection/Authentication/UI/WEB/Views//home.blade.php ENDPATH**/ ?>